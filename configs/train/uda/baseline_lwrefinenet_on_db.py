...
unsup_criterion = nn.CrossEntropyLoss(weight=torch.tensor([0.75, 1.5]))

unsup_batch_num_repetitions = 3

unsup_lambda_min = 0.001
unsup_lambda_max = 1.0
unsup_lambda_delta = (unsup_lambda_max - unsup_lambda_min) / ((num_epochs // 4) * le)
