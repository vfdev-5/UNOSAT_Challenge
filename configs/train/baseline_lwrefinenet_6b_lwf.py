...
from dataflow.datasets import get_trainval_datasets, read_img_as_6b_with_mask
...
train_ds, val_ds = get_trainval_datasets(data_path, csv_path, train_folds=train_folds, val_folds=val_folds, 
                                         read_img_mask_fn=read_img_as_6b_with_mask)
...
model = LWRefineNet(num_channels=6, num_classes=num_classes)
